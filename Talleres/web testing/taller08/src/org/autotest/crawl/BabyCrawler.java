...
public class BabyCrawler {
	...
	public WebSite crawl(String domainUrl) {
	    ...
	    while(!nextLinks.empty()) {
            ...
            try {
                ...
                website.addHttpStatusException(e.getStatusCode(), e.getUrl());
    ...
    private int updateNextLinks(Stack<String> nextLinks, Set<String> newLinks, Set<String> visited, String domainUrl) {
        ...
        for (String newLink : newLinks) {
            if (newLink.equals("https://icc.fcen.uba.ar/wp-content/uploads/2018/06/vinculaci%C3%B3n_tsu_icc.jpg")) {
                System.out.println("viniste de: ");
            }
    ...
    private void updateWebLinks(WebSite website, String currentUrl, Set<String> links) {
        for (String link : links) {
            if (link.equals("https://icc.fcen.uba.ar/wp-content/uploads/2018/06/vinculaci%C3%B3n_tsu_icc.jpg")) {
                System.out.println("viniste de: " + link);
            }
